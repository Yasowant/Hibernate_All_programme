...
//		entityTransaction.commit();
		...
		System.out.println("The sim No is:"+sim.getSno());
		System.out.println("The sim Provider is:"+sim.getProvider());
		System.out.println("The sim Type is:"+sim.getType());
		System.out.println("The Sim Cost is :"+sim.getCost());
		System.out.println("The Sim Phone No is"+sim.getPhno());
